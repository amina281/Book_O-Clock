...
class Book_tableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::create([
            ...
            'Language' => 'English',
            'Description' => ' To everyone who knows them, best friends Miel and Sam are as strange as 
            ...
            knows about his life before he and his mother moved to town.Atmospheric, dynamic, and packed with gorgeous 
            prose, When the Moon was Ours is another winner from this talented author.',
        ]);
        Product::create([
        ...
        Product::create([
            ...
            stake their claims through tempest, turmoil, and war.',
        ]);
        Product::create([
        ...
        Product::create([
            ...
            of the king\'s palace. Will her power save her or condemn her?Mare Barrow\'s world is divided by blood--those with common, 
        ...
        Product::create([
            ...
            'Language' => 'English',
            'Description' => 'Winner of the National Product Award, Nathaniel Philbrick\'s book is a fantastic saga of 
        ...
        Product::create([
            ...
            'Language' => 'English',
            'Description' => 'Paulo Coelho\'s masterpiece tells the mystical story of Santiago, an Andalusian shepherd 
            boy who yearns to travel in search of a worldly treasure. His quest will lead him to riches far different,
             and far more satisfying, listening to our hearts, of recognizing opportunity and learning to read the omens 
        ...
        Product::create([
            ...
            'Language' => 'English',
            'Description' => 'ne night in the reform club, Phileas Fogg bets his companions that he can travel across 
        ...
        Product::create([
            ...
            century: a journey down an extinct Icelandic volcano to the Earth\'s very core. In his quest to penetrate the 
